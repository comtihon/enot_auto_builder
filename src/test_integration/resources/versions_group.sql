...
insert into package_versions (version_id, repository_url, ref, erl_version) values('version_id2', 'url1', '1.0.0', '19');
insert into package_versions (version_id, repository_url, ref, erl_version) values('version_id3', 'url1', '1.0.0', '20');
...
insert into builds (build_id, package_version_id, result, message, artifact_path, created_date)
 values('build_id2', 'version_id2', 'true', 'artifact', '1.0.0/path', '2017-12-23');
insert into builds (build_id, package_version_id, result, message, artifact_path, created_date)
 values('build_id3', 'version_id3', 'true', 'artifact', '1.0.0/path', '2017-12-24');
