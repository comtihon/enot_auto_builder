...
public class RepositoryDAOServiceTest {
    ...
    public void saveSaveOne() {
        Repository repo = repositoryDAOService.getOrCreate("url", "comtihon/coon");
    ...
    public void saveMultipleVersions() {
        ...
        repo = repositoryDAOService.getOrCreate("url", "comtihon/coon");
    ...
    public void saveDifferentReposWithSameVersions() {
        Repository repo1 = repositoryDAOService.getOrCreate("url1", "comtihon/coon");
        Repository repo2 = repositoryDAOService.getOrCreate("url2", "comtihon/coon");
